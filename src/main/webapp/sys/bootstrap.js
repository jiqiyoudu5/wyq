...
Ext.ClassManager.addNameAlternateMappings({
  "EJ.Application": [],
  "EJ.controller.sys.chart.SYSUserChartController": [],
  "EJ.controller.sys.dictionary.SYSDictionaryController": [],
  "EJ.controller.sys.file.SYSFilesController": [],
  "EJ.controller.sys.mainController": [],
  "EJ.controller.sys.menu.SYSMenuController": [],
  "EJ.controller.sys.resource.SYSResourceController": [],
  "EJ.controller.sys.roles.SYSRoleController": [],
  "EJ.controller.sys.user.UserController": [],
  "EJ.model.sys.SYSMenuTreeModel": [],
  "EJ.model.sys.chart.UserChartModel": [],
  "EJ.model.sys.dictionary.SYSDicModel": [],
  "EJ.model.sys.dictionary.SYSDicTreeModel": [],
  "EJ.model.sys.file.SYSAttachedModel": [],
  "EJ.model.sys.menu.SYSConfigMenuModel": [],
  "EJ.model.sys.resource.SYSResourceModel": [],
  "EJ.model.sys.roles.SYSRoleModel": [],
  "EJ.model.sys.user.UserModel": [],
  "EJ.store.sys.SYSMenuTreeStore": [],
  "EJ.store.sys.chart.UserChartStore": [],
  "EJ.store.sys.dictionary.SYSDicStore": [],
  "EJ.store.sys.dictionary.SYSDicTreeStore": [],
  "EJ.store.sys.file.SYSDicFileHZ": [],
  "EJ.store.sys.file.SYSDicFileType": [],
  "EJ.store.sys.file.SYSFileStore": [],
  "EJ.store.sys.file.SYSMenuIcon": [],
  "EJ.store.sys.menu.SYSConfigMenuTreeStore": [],
  "EJ.store.sys.resource.SYSResourceStore": [],
  "EJ.store.sys.roles.SYSRoleNoResourceStore": [],
  "EJ.store.sys.roles.SYSRoleNoUserStore": [],
  "EJ.store.sys.roles.SYSRoleResourceStore": [],
  "EJ.store.sys.roles.SYSRoleStore": [],
  "EJ.store.sys.roles.SYSRoleUserStore": [],
  "EJ.store.sys.roles.SYSUserRoleStore": [],
  "EJ.store.sys.user.EndVipUserStore": [],
  "EJ.store.sys.user.ExpireVipUserStore": [],
  "EJ.store.sys.user.UserStore": [],
  "EJ.view.Viewport": [],
  "EJ.view.sys.Banner": [],
  "EJ.view.sys.Main": [],
  "EJ.view.sys.SYSHome": [],
  "EJ.view.sys.SYSMenuTree": [],
  "EJ.view.sys.chart.FindChartByTimeForm": [],
  "EJ.view.sys.chart.FindChartByTypeForm": [],
  "EJ.view.sys.chart.UserChart": [],
  "EJ.view.sys.database.BackManager": [],
  "EJ.view.sys.database.RestoreManager": [],
  "EJ.view.sys.dictionary.AddDicTypeWin": [],
  "EJ.view.sys.dictionary.AddDicWin": [],
  "EJ.view.sys.dictionary.SYSDicList": [],
  "EJ.view.sys.dictionary.SYSDicTreeList": [],
  "EJ.view.sys.dictionary.SYSDictionaryMain": [],
  "EJ.view.sys.dictionary.UpdateDicTypeWin": [],
  "EJ.view.sys.dictionary.UpdateDicWin": [],
  "EJ.view.sys.files.List": [],
  "EJ.view.sys.files.Manager": [],
  "EJ.view.sys.files.UploadWindow": [],
  "EJ.view.sys.menu.SYSAddMenu": [],
  "EJ.view.sys.menu.SYSEditMenu": [],
  "EJ.view.sys.menu.SYSTreeList": [],
  "EJ.view.sys.resource.AddWin": [],
  "EJ.view.sys.resource.EditResWin": [],
  "EJ.view.sys.resource.SYSResourceList": [],
  "EJ.view.sys.resource.SearchForm": [],
  "EJ.view.sys.roles.AddWin": [],
  "EJ.view.sys.roles.EditRoleWin": [],
  "EJ.view.sys.roles.RoleInfoWin": [],
  "EJ.view.sys.roles.SYSRoleList": [],
  "EJ.view.sys.roles.SYSRoleMain": [],
  "EJ.view.sys.roles.SYSRoleMenuTab": [],
  "EJ.view.sys.roles.SYSRoleResourcesConfigWin": [],
  "EJ.view.sys.roles.SYSRoleResourcesTab": [],
  "EJ.view.sys.roles.SYSRoleUsersConfigWin": [],
  "EJ.view.sys.roles.SYSRoleUsersTab": [],
  "EJ.view.sys.user.EndVipUserList": [],
  "EJ.view.sys.user.ExpireVipUserList": [],
  "EJ.view.sys.user.ModifcationUserForm": [],
  "EJ.view.sys.user.ModifcationUserPassword": [],
  "EJ.view.sys.user.ModifcationUserWin": [],
  "EJ.view.sys.user.RegistUserForm": [],
  "EJ.view.sys.user.RegistUserWin": [],
  "EJ.view.sys.user.RemoveUserRolesWin": [],
  "EJ.view.sys.user.SearchUserWin": [],
  "EJ.view.sys.user.UserInfoWin": [],
  "EJ.view.sys.user.UserList": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "EJ.view.sys.chart.FindChartByTimeForm": [
    "widget.findChartByTimeForm"
  ],
  "EJ.view.sys.chart.FindChartByTypeForm": [
    "widget.findChartByTypeForm"
  ],
  "EJ.view.sys.chart.UserChart": [
    "widget.userChart"
  ],
  ...
  "EJ.view.sys.database.RestoreManager": [
    "widget.restoreManager"
  ],
  "EJ.view.sys.dictionary.AddDicTypeWin": [
    "widget.addSYSDicTypeWin"
  ],
  "EJ.view.sys.dictionary.AddDicWin": [
    "widget.addSYSDicWin"
  ],
  ...
  "EJ.view.sys.dictionary.SYSDicTreeList": [
    "widget.sysDicTreeList"
  ],
  "EJ.view.sys.dictionary.SYSDictionaryMain": [
    "widget.sysDictionaryMain"
  ],
  "EJ.view.sys.dictionary.UpdateDicTypeWin": [
    "widget.updateDicTypeWin"
  ],
  "EJ.view.sys.dictionary.UpdateDicWin": [
    "widget.updateDicWin"
  ],
  ...
  "EJ.view.sys.resource.AddWin": [
    "widget.addWinResource"
  ],
  "EJ.view.sys.resource.EditResWin": [
    "widget.editResWin"
  ],
  "EJ.view.sys.resource.SYSResourceList": [
    "widget.sysResourceList"
  ],
  "EJ.view.sys.resource.SearchForm": [
    "widget.searchForm"
  ],
  ...
  "EJ.view.sys.roles.SYSRoleMenuTab": [
    "widget.sysRoleMenuTab"
  ],
  "EJ.view.sys.roles.SYSRoleResourcesConfigWin": [
    "widget.sysRoleResourcesConfigWin"
  ],
  "EJ.view.sys.roles.SYSRoleResourcesTab": [
    "widget.sysRoleResourcesTab"
  ],
  "EJ.view.sys.roles.SYSRoleUsersConfigWin": [
    "widget.sysRoleUsersConfigWin"
  ],
  "EJ.view.sys.roles.SYSRoleUsersTab": [
    "widget.sysRoleUsersTab"
  ],
  "EJ.view.sys.user.EndVipUserList": [
    "widget.endVipUserList"
  ],
  "EJ.view.sys.user.ExpireVipUserList": [
    "widget.expireVipUserList"
  ],
  "EJ.view.sys.user.ModifcationUserForm": [
    "widget.modifcationUserForm"
  ],
  "EJ.view.sys.user.ModifcationUserPassword": [
    "widget.modifcationUserPassword"
  ],
  "EJ.view.sys.user.ModifcationUserWin": [
    "widget.modifcationUserWin"
  ],
  "EJ.view.sys.user.RegistUserForm": [
    "widget.registUserForm"
  ],
  "EJ.view.sys.user.RegistUserWin": [
    "widget.registUserWin"
  ],
  "EJ.view.sys.user.RemoveUserRolesWin": [
    "widget.removeUserRolesWin"
  ],
  "EJ.view.sys.user.SearchUserWin": [
    "widget.searchUserWin"
  ],
  "EJ.view.sys.user.UserInfoWin": [
    "widget.userInfoWin"
  ],
