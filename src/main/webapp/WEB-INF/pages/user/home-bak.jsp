...
<link href="../resources/css/userhome.css" rel="stylesheet" type="text/css" />
...
<!-- header --> 
    <div class="header"><img src="../resources/img/logo2.png"/></div>
<!-- header end -->
...
<!-- content -->
        <div class="content"><iframe name="content" frameborder="0" height="100%" width="100%" scrolling="auto"></iframe>
        </div>
<!-- content end -->
